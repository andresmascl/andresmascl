...
- In some cases the contact information needed to reach the companies to be surveyed was provided using [Licitaciones24x7.cl](https://licitaciones24x7.cl)'s internal API.
